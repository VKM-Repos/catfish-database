...
function Calendar({
  ...
  const _dayButtonClassName = cn(
    ...
    'size-8 rounded-md p-0 px-1 font-normal transition-none',
  ...
  const _selectedClassName = cn(
    '[&>button]:bg-primary-500 [&>button]:text-white [&>button]:hover:text-white',
    props.selectedClassName,
  )
  const _todayClassName = cn('[&>button]:bg-primary-200 [&>button]:text-accent-foreground', props.todayClassName)
...
function YearGrid({
  ...
  return (
    <div className={cn('grid w-full grid-cols-4 gap-y-2', className)} {...props}>
