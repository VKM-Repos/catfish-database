...
export default function FeedingInsight() {
  ...
  const useGetFeedConsumed = createGetQueryHook({
    endpoint: '/dashboards/cluster/feed-consumption-trend?interval=ALL',
  ...
  const useGetFeedPriceSummary = createGetQueryHook({
    endpoint: '/dashboards/cluster/feed-price-summary',
    responseSchema: z.any(),
    queryKey: ['feed-price-summary-summary-cluster-manager'],
  })
