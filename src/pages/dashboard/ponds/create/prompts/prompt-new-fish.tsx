...
export default function PromptNewFish({
  open,
  setOpen,
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-h-fit w-fit overflow-hidden px-[2.5rem] py-[3.75rem] shadow-[0px_4px_16px_-8px_#0F4B2F29]">
        <VisuallyHidden>
          <DialogTitle>Add more fish to the pond?</DialogTitle>
          <DialogDescription>
            This popup allows you to either start a new process to add fish to a pond or leave the page
          </DialogDescription>
        </VisuallyHidden>
        <FlexBox direction="col" justify="between" gap="gap-[3.25rem]" align="center">
          <FlexBox direction="col" gap="gap-2" align="center">
            <Heading level={5} weight="bold">
              Success! Fish added to pond
            </Heading>
            <Text className="text-center">
              Would you like to add more fish your pond ? You can always do this later from your dashboard
            </Text>
          </FlexBox>
