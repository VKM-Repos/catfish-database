                  ...
                  >
                    ...
                    <div
                      className={`h-10 rounded-br-md rounded-tr-md px-3 py-[.65rem] text-xs ${
                        activeInputs.dissolvedOxygen ? 'bg-primary-500 text-white' : 'bg-neutral-100 text-neutral-400'
                      }`}
                    >
                      mg/L
                    </div>
                  ...
                  >
                    ...
                    <div
                      className={`h-10 w-[95px] rounded-br-md rounded-tr-md px-3 py-[.65rem] text-xs ${
                        activeInputs.phLevel ? 'bg-primary-500  text-white' : 'bg-neutral-100 text-neutral-400'
                      }`}
                    >
                      1{'-'}14 scale)
                    </div>
                  ...
                  >
                    ...
                    <div
                      className={`h-10 w-[50px] rounded-br-md rounded-tr-md px-3 py-[.65rem] text-xs ${
                        activeInputs.temperature ? 'bg-primary-500 text-white' : 'bg-neutral-100 text-neutral-400'
                      }`}
                    >
              ...
              <FormItem>
                <FormControl>
                  ...
                  >
                    ...
                    <div
                      className={`h-10 rounded-br-md rounded-tr-md px-3 py-[.65rem] text-xs ${
                        activeInputs.ammonia ? 'bg-primary-500 text-white' : 'bg-neutral-100 text-neutral-400'
                      }`}
                    >
                      mg/L
                    </div>
              ...
              <FormItem>
                <FormControl>
                  ...
                  >
                    ...
                    <div
                      className={`h-10 rounded-br-md rounded-tr-md px-3 py-[.65rem] text-xs ${
                        activeInputs.nitrite ? 'bg-primary-500 text-white' : 'bg-neutral-100 text-neutral-400'
                      }`}
                    >
                      mg/L
                    </div>
                  ...
                  >
                    ...
                    <div
                      className={`h-10 w-[130px] rounded-br-md rounded-tr-md px-3 py-[.65rem] text-xs ${
                        activeInputs.alkalinity ? 'bg-primary-500 text-white' : 'bg-neutral-100 text-neutral-400'
                      }`}
                    >
                      mg/L CaCO <sub>3</sub>
                    </div>
              ...
              <FormItem>
                <FormControl>
                  ...
                  >
                    ...
                    <div
                      className={`h-10 w-[130px] rounded-br-md rounded-tr-md px-3 py-[.65rem] text-xs ${
                        activeInputs.hardness ? 'bg-primary-500 text-white' : 'bg-neutral-100 text-neutral-500'
                      }`}
                    >
                      mg/L CaCO <sub>3</sub>
                    </div>
