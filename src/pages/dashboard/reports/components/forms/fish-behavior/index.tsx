                  ...
                  <div className="flex w-full flex-col gap-2">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormControl>
                            <div className="focus-within:ring-offset-background max-h-fit items-center rounded-md border border-neutral-200 px-2 focus-within:ring-2 focus-within:ring-primary-500 focus-within:ring-offset-2">
                              <Input
