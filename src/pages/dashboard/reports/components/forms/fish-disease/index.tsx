...
export function FishDisease({
  ...
  const diseases = [
    ...
    { value: 'COLUMNARIS', text: 'Columnaris (Cottonmouth Disease)' },
    { value: 'ICH_WHITE_SPOT', text: 'Ich (Ichthyophthirius multifiliis) / White Spot' },
    { value: 'YELLOW_RED_ULCER', text: 'Yellow or Red Ulcer Disease' },
    { value: 'GILL_FLUKES', text: 'Gill Flukes (Monogenean Parasites)' },
    { value: 'MOUTH_ROT', text: 'Mouth Rot' },
    { value: 'TAIL_ROT', text: 'Tail Rot' },
    { value: 'FUNGAL_SWIM_BLADDER', text: 'Fungal Infection Swim Bladder Disorder' },
    { value: 'DROPSY', text: 'Dropsy (Bloating/Ascites)' },
    { value: 'EXTERNAL_PARASITES', text: 'External Parasites' },
    { value: 'BACTERIAL', text: 'Bacterial' },
  ]
  return (
    <>
          ...
          <Card className="p-[24px]">
            <div className="flex flex-col items-start space-y-[8px]">
              <Text className="flex items-center gap-2 text-sm font-medium text-neutral-700">
                Do you want to record disease occurrence ? <span className="font-bold text-red-500">*</span>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormControl>
                            <div
                              className={`focus-within:ring-offset-background max-h-fit w-full items-center rounded-md border border-neutral-200 focus-within:ring-2 focus-within:ring-primary-500 focus-within:ring-offset-2`}
                            >
                              <Input
                                ...
                                className="w-full max-w-full border-0 px-3 text-sm focus-visible:ring-0 focus-visible:ring-offset-0"
                              />
                            </div>
                          </FormControl>
                          <FormMessage />
