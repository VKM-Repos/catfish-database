        ...
        <div>
          ...
          <div className="flex flex-col gap-5 rounded-lg border border-neutral-200 p-5">
            ...
            <div className="flex w-full items-center gap-5">
              <div className="flex w-full flex-col gap-2">
                <Text className="flex items-center gap-2 text-sm font-medium text-neutral-700">
                  Avg. Weight of Fish Harvested <span className="font-bold text-red-500">*</span>
                  <SolarIconSet.QuestionCircle size={16} />
                  {/* <Text className="font-light text-neutral-500">(Optional)</Text> */}
                </Text>
                <FormField
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <div
                          className={`focus-within:ring-offset-background flex max-h-fit w-full items-center rounded-md border border-neutral-200 px-2 focus-within:ring-2 focus-within:ring-primary-500 focus-within:ring-offset-2`}
                        >
                          <span>
                            <svg
                              width="20"
