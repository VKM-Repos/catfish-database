    ...
    <>
      ...
      <FlexBox direction="col" gap="gap-5" align="center" className="mx-auto mt-10 w-full max-w-[60%]">
        <>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-full flex-col space-y-8 pb-0.5">
              ...
              <div className="w-full">
                {recordWaterQuality && (
                  <div className="">
                    ...
                    <div className="w-full rounded-lg border border-neutral-300 p-5">
                      <WaterQualityForm recordWaterQuality={recordWaterQuality} form={form} />
                    </div>
                  </div>
                )}
              </div>
