...
export function FeedForm({ mode, initialValues, onSuccess, onClose }: FarmerProps) {
  ...
  // const useCreateFeed = createPostMutationHook({
  ...
  // const useUpdateFeed = createPutMutationHook({
    ...
    <>
      <div className="absolute inset-x-0 top-0 w-full border-b border-b-neutral-200 py-2">
        <Heading className="text-center" level={6}>
          {mode === 'create' ? 'Add feed type' : ' Edit feed type'}
        </Heading>
      </div>
      <Form {...form}>
