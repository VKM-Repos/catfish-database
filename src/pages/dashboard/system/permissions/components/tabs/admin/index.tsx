...
const initialPermissions: Permissions[] = [
  ...
  { module: 'clusterManagement', access: false, view: false, create: true, edit: false, delete: false },
  { module: 'systemConfig', access: false, view: false, create: false, edit: false, delete: false },
  { module: 'pondSetup', access: true, view: false, create: false, edit: false, delete: false },
  { module: 'batchSetup', access: false, view: false, create: false, edit: true, delete: false },
  { module: 'farmReport', access: false, view: false, create: true, edit: true, delete: false },
  { module: 'sampling', access: false, view: false, create: false, edit: false, delete: false },
  { module: 'harvestReport', access: false, view: false, create: false, edit: false, delete: false },
  { module: 'reportingAnalytics', access: false, view: false, create: true, edit: false, delete: false },
  { module: 'maintenance', access: true, view: false, create: false, edit: true, delete: false },
]
