...
const initialPermissions: Permissions[] = [
  ...
  { module: 'farmReport', access: false, view: false, create: false, edit: false, delete: false },
  ...
  { module: 'reportingAnalytics', access: false, view: false, create: false, edit: false, delete: false },
  { module: 'maintenance', access: true, view: false, create: false, edit: false, delete: false },
]

export default function FarmerPermissions() {
